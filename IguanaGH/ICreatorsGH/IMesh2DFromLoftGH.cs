...
namespace IguanaMeshGH.ICreators
{
    public class IMesh2DFromLoftGH : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            IMesh mesh = IKernel.IMeshingKernel.CreateShellMeshFromCurveLoft(crv, solver, out logInfo, out entities, constraints, transfinites, field);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Properties.Resources.iLoft;
            }
        }
