        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            foreach (int eK in mesh.ElementsKeys)
            {
                ...
                for (int i = 1; i <= e.HalfFacetsCount; i++)
                {
                    ...
                    if (sibData != 0)
                    {
                        if (e.TopologicDimension == 1) msg = new GH_String("Edge Element ID: " + e.GetSiblingElementID(i) + " :: Half-Edge ID: " + e.GetSiblingHalfFacetID(i));
                    ...
                    {
                        if (e.TopologicDimension == 1) msg = new GH_String("Naked Half-Edge");
