...
{
    public class IMeshingTetraPrismHighOrderGH : GH_Component
    {
        IguanaGmshSolver3D solverOpt;
        double sizeFactor = 1.0, minSize = 0, maxSize = 1e+22, qualityThreshold = 0.3;
        int steps = 10, qualityType = 2, ho_optimization = 0, minPts = 10, minElemPerTwoPi = 6;
        bool adaptive = false;

        /// <summary>
        /// Initializes a new instance of the IMeshing3DHighOrderGH class.
        /// </summary>
        public IMeshingTetraPrismHighOrderGH()
          : base("iTetraPrismHighOrderSettings", "iTetraPrismHighOrder",
              "Configuration for tetrahedrons+prisms high-order mesh generation.",
              "Iguana", "Settings")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.GetData(9, ref ho_optimization);
        ...
        {
            get { return new Guid("3d2fe610-78ba-4c96-8d9f-3d91b573d5a3"); }
        }
    }
}