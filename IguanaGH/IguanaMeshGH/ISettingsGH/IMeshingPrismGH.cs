...
namespace IguanaGH.IguanaMeshGH.ISettingsGH
{
    public class IMeshingPrismGH : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("Optimize", "Optimize", "Optimization method (-1: No optimization, 0: Standard, 1: Netgen, 2: HighOrder, 3: HighOrderElastic, 4: HighOrderFastCurving, 5: Laplace2D, 6: Relocate2D, 7: Relocate3D) Default value is 0.", GH_ParamAccess.item, optimize);
