...
{
    public class IDeconstructorGH : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the AHF_DeconstructDataStructure class.
        /// </summary>
        public IDeconstructorGH()
          : base("iMesh Deconstructor", "iDeconstructor",
              "Retrieve all the information from the Array-based Half-Facet (AHF) Mesh Data Structure.",
              "Iguana", "Utils")
        {
        }
        ...
        {
            pManager.AddGenericParameter("iVertices", "iV", "Topologic Vertices", GH_ParamAccess.tree);
            pManager.AddIntegerParameter("iKeysV", "kV", "Vertex Keys", GH_ParamAccess.tree);
            pManager.AddGenericParameter("iElements", "iE", "Elements", GH_ParamAccess.tree);
            pManager.AddIntegerParameter("iKeysE", "kE", "Elements Keys", GH_ParamAccess.tree);
