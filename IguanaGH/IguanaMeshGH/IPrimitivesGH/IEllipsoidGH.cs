...
{
    public class IEllipsoidGH : GH_Component
    {
        private IMesh mesh;
        /// <summary>
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("V Count", "V", "Number of faces along the {y} direction.", GH_ParamAccess.item, 30);
            ...
            pManager.AddIntervalParameter("Domain {x}", "D1", "Domain in the {x} direction. The domain should be bounded between 0 to π.", GH_ParamAccess.item, new Interval(0, Math.PI));
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            int v = 30;
            double a = 1, b = 1, c = 1;
            Interval D1 = new Interval(0, Math.PI);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Properties.Resources.iSphere;
            }
        }
        ...
        {
            get { return new Guid("1547ae01-1aba-43cd-9c90-46679198856c"); }
        }
    }
}