...
namespace IguanaGH.IguanaMeshGH.IPrimitivesGH
{
    public class IHyperboloidOneSheetGH : GH_Component
    {
        ...
        public IHyperboloidOneSheetGH()
          : base("iMesh HyperboloidOneSheet Constructor", "iHyperboloidOneSheet",
              "Creates a hyperboloid of one sheet quad-mesh stored via an Array-based Half-Facet (AHF) Mesh Data Structure.",
              "Iguana", "Primitives")
        {
        }
