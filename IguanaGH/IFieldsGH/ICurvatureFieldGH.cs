...
namespace IguanaMeshGH.IFields
{
    public class ICurvatureFieldGH : GH_Component
    {
        ...
        public ICurvatureFieldGH()
          : base("iCurvatureField", "iCurvatureField",
              "Compute the curvature of a field to specify the size of mesh elements.",
              "Iguana", "Fields")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("StepSize", "StepSize", "Step size of finite differences. Default is " + delta, GH_ParamAccess.item, delta);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            IField.Curvature field = new IField.Curvature();
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Properties.Resources.iCurvatureField;
            }
        }
