...
namespace IguanaMeshGH.IFields
{
    public class ILaplacianFieldGH : GH_Component
    {
        ...
        public ILaplacianFieldGH()
          : base("iLaplacianField", "iLaplacianField",
              "Compute the Laplace operator of a field to specify the size of mesh elements.",
              "Iguana", "Fields")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            IField.Laplacian field = new IField.Laplacian();
