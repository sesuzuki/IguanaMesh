...
namespace IguanaMeshGH.IFields
{
    public class ICylinderFieldGH : GH_Component
    {
        ...
        public ICylinderFieldGH()
          : base("iCylinderField", "iCylinderField",
              "Compute a cylinder field to specify the size of mesh elements.",
              "Iguana", "Fields")
        {
        }
        ...
        {
            pManager.AddSurfaceParameter("Cylinder", "C", "Base cylinder surface.", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var srf = s.ToNurbsSurface();

            if (srf.IsCylinder(0.01))
            {
                Cylinder c;
                srf.TryGetCylinder(out c, 0.01);
                IField.Cylinder field = new IField.Cylinder();
