...
namespace IguanaMeshGH.IFields
{
    public class IMinAnisoFieldGH : GH_Component
    {
        ...
        public IMinAnisoFieldGH()
          : base("iMinAnisoField", "iMinAnisoField",
              "Compute the minimum from the intersection of different anisotropic fields to specify the size of mesh elements.",
              "Iguana", "Fields")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            IField.MinAniso field = new IField.MinAniso();
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Properties.Resources.iMinAnisoField;
            }
        }
