...
namespace IguanaMeshGH.IFields
{
    public class IMaxEigenHessianFieldGH : GH_Component
    {
        ...
        public IMaxEigenHessianFieldGH()
          : base("iMaxEigenHessianField", "iMaxEigenHessianField",
              "Compute the maximum eigenvalue of the Hessian matrix of a field to specify the size of mesh elements.",
              "Iguana", "Fields")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            IField.MaxEigenHessian field = new IField.MaxEigenHessian();
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Properties.Resources.iEigenHessianField;
            }
        }
