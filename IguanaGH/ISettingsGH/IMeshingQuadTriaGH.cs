...
namespace IguanaMeshGH.ISettings
{
    public class IMeshingQuadsTriasGH : GH_Component
    {
        ...
        public IMeshingQuadsTriasGH()
          : base("iLinearQuadTria", "iLinearQuadTria",
              "Solver configuration for linear quad-dominant mesh generation.",
              "Iguana", "Settings")
        {
        }
        ...
        {
            pManager.AddGenericParameter("iSettings", "iSettings", "Solver configuration for linear quad-dominant generation.", GH_ParamAccess.item);
        }
